The calorie calculation logic in AIContext.tsx has been updated to correctly parse and calculate proportional calories based on user input.
```
...
const generateResponse = async (prompt: string): Promise<string> => {
  try {
    ...
    if (foodMatch) {
      const [, totalAmount, unit1, foodName, servingSize, unit2, caloriesPerServing] = foodMatch;
